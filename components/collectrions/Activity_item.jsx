						...
						{data.slice(0, 5).map((item) => {
							...
							return (
								<Link href={`/item/${itemLink}`} key={id}>
									<span className="dark:bg-jacarta-700 dark:border-jacarta-700 border-jacarta-100 rounded-2.5xl relative flex items-center border bg-white p-8 transition-shadow hover:shadow-lg">
