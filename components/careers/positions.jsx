			...
			<section className="relative pb-24">
				<div className="container">
						...
						{careers_positions_data.map((item) => {
							...
							return (
								...
								>
									...
									<Link href="/contact">
										<span className="text-sm font-bold text-accent">Apply Now</span>
									</Link>
								</div>
							);
						})}
					...
					<div className="mx-auto mt-20 max-w-md rounded-2lg bg-light-base py-5 px-10 text-center dark:bg-jacarta-700 sm:flex sm:items-center sm:text-left">
						...
						<Link href="/contact">
							<span className="ml-auto inline-block rounded-full bg-accent py-2.5 px-8 text-center text-sm font-semibold text-white shadow-accent-volume transition-all hover:bg-accent-dark">
